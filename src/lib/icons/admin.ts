/**
 * In-repo icon set for admin UI. Stroke-based 24x24 icons (Lucide-style).
 * No external requests; all SVGs are in the codebase.
 */
export const icons = {
	dashboard:
	...
	edit:
		'<path d="M17 3a2.83 2.83 0 0 1 4 4L7 21l-4 1 1-4Z"/><path d="m15 5 4 4"/>',
	trash:
